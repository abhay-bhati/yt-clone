    ...
    return (
        <div className='header'>
            ...
            <div className='header__right'>
                ...
                <Avatar style={{ height: '32px' }} className='header__icon' alt='profile image' src='https://expertphotography.b-cdn.net/wp-content/uploads/2020/08/social-media-profile-photos-3.jpg' />
            </div>
